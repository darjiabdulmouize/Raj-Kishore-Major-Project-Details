...
st.markdown(f'<h1 style="color:#000000 ;text-align: center;font-size:50px;font-family:Caveat, sans-serif;">{"Customer Relationship Management by sentiment analysis in AI technology"}</h1>', unsafe_allow_html=True)
